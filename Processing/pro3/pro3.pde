...
void setup() {
  size(600, 600);
  fish = new Fish();
  logo = loadShape("pill.png");
  myCupcake1 = new Cupcake();
  myFont  = createFont("Arial",10);
  //myFont  = createFont("Bim", 32);
  bubble = loadImage("pill.png");
  cupcake1 = loadShape("weed.png");
  fish1 = loadShape("weed.png");
  ocean = loadImage("weed.png");
  //start1 = createFont("Bim", 50);
  //myFont2 = createFont("AppleM", 20);
  start1 = createFont("Arial",10);
  myFont2 = createFont("Arial",10);
  for (int x = 0; x < amt ; x++) {
